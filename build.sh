...
COMMON_DEBUG_COMPILER_FLAGS="-O0 -DEDITOR_DEBUG=1 -ggdb -fno-omit-frame-pointer $COMMON_COMPILER_FLAGS"
COMMON_RELEASE_COMPILER_FLAGS="-O3 -DEDITOR_DEBUG=0 $COMMON_COMPILER_FLAGS"
