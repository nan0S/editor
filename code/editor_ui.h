...
internal changed_b32       UI_DragFloat2(v2 *Values, f32 MinValue, f32 MaxValue, char const *ValueFormat, string Label);
...
internal changed_b32       UI_InputText2F(char_buffer *Buffer, u32 InputWidthInChars, char const *Format, ...);
...
internal clicked_b32       UI_MenuItem(b32 *Selected, string Shortcut, string Label);
internal clicked_b32       UI_MenuItemF(b32 *Selected, string Shortcut, char const *Format, ...);
