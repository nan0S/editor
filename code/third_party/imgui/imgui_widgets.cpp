...
// - DataTypeCompare()
// - DataTypeClamp()
// - GetMinmumStepAtDecimalPrecision
...
static float GetMinmumStepAtDecimalPrecision(int decimal_precision)
{
...
bool ImGui::DragBehaviorT(ImGuiDataType data_type, TYPE* v, float v_speed, const TYPE v_min, const TYPE v_max, const char* format, ImGuiSliderFlags flags)
{
 ...
 else if (g.ActiveIdSource == ImGuiInputSource_Nav)
 {
  ...
  v_speed = ImMax(v_speed, GetMinmumStepAtDecimalPrecision(decimal_precision));
 }
...
int ImParseFormatPrecision(const char* fmt, int default_precision)
{
 ...
 if (*fmt == 'e' || *fmt == 'E') // Maxmum precision with scientific notation
  precision = -1;
